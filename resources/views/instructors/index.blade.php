...
<body>
    ...
    <div class="container mt-4">
        ...
        <p>Aantal instructeurs: {{ count($instructors) }}</p>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('instructors.vehicles', $instructor->id) }}" class="btn btn-sm btn-outline-primary">
                                    ...
                                    {{-- Check if $instructor->voertuigInstructeurs exists, otherwise show 0 --}}
                                    <span class="badge bg-primary">
                                        {{ isset($instructor->voertuigInstructeurs) ? count($instructor->voertuigInstructeurs) : 0 }}
                                    </span>

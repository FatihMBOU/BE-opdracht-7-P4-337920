        ...
        <div class="row mb-4 justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Dit platform helpt u bij het efficiënt organiseren van uw rijschool. U beheert hier eenvoudig alle instructeurs en voertuigen.</p>
                        <p>Klik op 'Instructeurs in dienst' in het menu om een actueel overzicht van alle instructeurs te bekijken.</p>
                        <a href="{{ route('instructors.index') }}" class="btn btn-primary">Bekijk alle instructeurs</a>
                    </div>
                </div>
            </div>
        </div>
